      ...
      <main className=" w-full relative overflow-hidden">
        ...
        <section className="px-4 max-w-7xl mx-auto grid grid-cols-2 items-center py-20">
          <div className="bg-blue-default text-white p-8 rounded-2xl ">
            ...
            <p className="text-lg">
              ...
              nous mettons l’humain, l’environnement et la solidarité au cœur de nos actions. <br/>
              En offrant des solutions qui favorisent le bien-être des salariés, soutiennent des causes d’intérêt
              général et réduisent l’empreinte environnementale, nous contribuons activement à bâtir un avenir durable
        ...
        <section id="testimonies" className="w-full bg-blue-default py-20">
          <div className="maw-w-7xl mx-auto px-4">
            ...
            <div className="flex justify-between items-stretch flex-wrap">
              <article
                className="flex-col items-center justify-center w-1/4 mx-auto bg-white p-5 rounded-2xl text-center">
                ...
                <p className="m-2">En tant qu&apos;entreprise, nous avions du mal à motiver nos équipes avec les outils
                  traditionnels. Depuis que nous utilisons cette solution, nos collaborateurs bénéficient
                  d&apos;activités engageantes et d&apos;un suivi clair de leurs performances. Côté entreprise, la
                  gestion est simplifiée grâce à une plateforme ergonomique qui regroupe tout en un seul endroit.</p>
              ...
              <article
                ...
                <p className="m-2">Nous cherchions une solution moderne pour dynamiser nos équipes tout en restant
                  alignés avec nos valeurs d’entreprise. Cette application a complètement transformé notre approche. En
                  plus de motiver les salariés avec des défis sportifs personnalisés, nous pouvons communiquer
                  facilement nos engagements RSE et impliquer les collaborateurs dans des causes qui leur tiennent à
                  cœur.</p>
              ...
              <article
                ...
                <p className="m-2">Nous avions déjà un programme d&apos;avantages, mais il manquait une vraie
                  personnalisation. Avec cette solution, nous avons pu offrir des activités sur mesure à nos
                  collaborateurs et centraliser tous les services dans une application intuitive. Le gain de temps pour
                  les administrateurs est énorme, et les salariés sont ravis de voir des récompenses concrètes pour
                  leurs efforts.</p>
        ...
        <section id="pictures" className="py-10">
          <div className="my-5 max-w-7xl mx-auto px-4 ">
            ...
            <p className="text-center w-2/3 mx-auto m-10">Découvrez les témoignages de nos clients satisfaits qui ont
              fait le choix d’unir bien-être au travail, engagement sportif et soutien à des causes solidaires. Grâce à
              notre solution, ces entreprises ont non seulement renforcé la cohésion et la motivation de leurs équipes,
              mais elles ont aussi contribué à des initiatives positives, en phase avec leurs valeurs.</p>
          </div>
        ...
        <section id="contact" className="py-20 bg-green-default">
          <div className="max-width-7xl mx-auto">
            ...
            <p className="text-center w-2/3 mx-auto my-5"><strong>Profitiez facilement de notre solution<br/>3,2,1 …
              Commençons !</strong></p>
          </div>
